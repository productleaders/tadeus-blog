...
metaDescription: "Employees don't refuse AI, they refuse slow AI. Why response latency is both the adoption curve and a proxy for whether an answer meant anything."
heroImage: "images/employees-wont-talk-to-a-robot-latency.webp"
heroImageAlt: "8 Employees Won't Talk to a Robot"
faqs:
  - question: "Is response latency the same as system speed?"
    answer: "No. System latency is how fast the platform responds to a person. Human response latency is how long a person takes to answer a question. The first is an adoption and experience factor. The second is a behavioural signal about how much thinking a question required. You need low system latency before human latency becomes readable, because otherwise you can't tell the person's pause apart from the machine's lag."
  - question: "Do employees trust AI more than their managers?"
    answer: "Not exactly. The research shows they disclose more to automated interviewers because the fear of judgment and the relational risk disappear. Trust in the organisation still determines whether they believe anything will change as a result. The machine solves the candour problem; leadership still owns the action problem."
  - question: "Does a fast answer mean a bad answer?"
    answer: "Not on its own. A fast answer to a factual question is normal. The signal is in the pattern across a conversation, particularly when a reflective question that should demand processing comes back instantly. That collapse in latency usually means cognitive load has dropped, which often means the person has stopped engaging even though they're still producing words."
  - question: "Why not just add more questions to get better data?"
    answer: "Because volume and quality aren't the same thing. Adding questions to a disengaged respondent produces more autopilot output that reads as complete data but carries no signal. When behavioural cues show someone has checked out, the useful move is to shorten, adapt, or stop, not to ask more. A completed response tells you the screen advanced, not that a human was present."
  - question: "Are employees really more willing to talk to a fast voice system?"
    answer: "The research points two directions that meet in the middle. Timing failures, repeated errors, and clumsy turn-taking are the main drivers of disengagement, rather than the presence of automation itself. And controlled studies show people disclose more to interviewers they believe are automated, because the fear of judgment drops. Poor timing is what breaks trust. The machine, handled well, is what earns the honesty."
draft: false
---
...
That instinct has evidence behind it. Research into how people react to robot errors in real settings found that when a system made [successive mistakes, roughly 46% of interactions ended in disengagement](https://arxiv.org/html/2602.05010v1), people looked at their phones, read something else, or simply walked away. The pattern in human-robot interaction research is consistent: many of the failures that break trust are [timing and ordering failures](https://pmc.ncbi.nlm.nih.gov/articles/PMC6013580), where events happen in the wrong sequence or a waiting period times out before the exchange resolves. And separate work has found that working alongside robots can produce [measurable negative psychological effects](https://biz.source.colostate.edu/research-finds-robots-negatively-impact-humans-who-work-around-them), including feeling less socially connected.
...
Contrast that with what most tools do, which is nothing, because they can't see the pattern at all. They treat a finished survey as a good survey. Given that Gallup's midyear check found [around 32% of the US workforce disengaged](https://www.nojitter.com/digital-workplace/workers-are-disengaged-ai-isn-t-helping-), a meaningful share of every dataset is being produced by people who've mentally left. A system that reacts to that in real time collects less, but what it collects is quality-checked input. A system that ploughs on collects more of exactly the data you shouldn't act on.
...
- [Signal or 'Noise': Human Reactions to Robot Errors in the Wild](https://arxiv.org/html/2602.05010v1), arXiv. Found that successive robot errors drove disengagement in roughly 46% of observed interactions.
- [Understanding and Resolving Failures in Human-Robot Interaction](https://pmc.ncbi.nlm.nih.gov/articles/PMC6013580), PMC / NCBI. Literature review identifying timing and ordering as recurring failure types in human-robot interaction.
...
- [Milliken, Morrison and Hewlin, An Exploratory Study of Employee Silence](https://instituteforpr.org/employee-silence-and-upward-communication/), Journal of Management Studies, 2003. On the 85% of employees who have withheld an important issue.
...
- [Research: Working with robots has negative psychological effects](https://biz.source.colostate.edu/research-finds-robots-negatively-impact-humans-who-work-around-them), Colorado State University. On reduced social connection among workers around robots.
- [Workers Are Disengaged. AI Isn't Helping.](https://www.nojitter.com/digital-workplace/workers-are-disengaged-ai-isn-t-helping-), No Jitter, reporting Gallup's midyear finding of around 32% US workforce disengagement.
